...
class DroneControl{
    ...
    DroneControl(ros::NodeHandle& n, ros::Rate& rate){
        ...
        collision_sub = n.subscribe<std_msgs::Float32MultiArray>("course_correction", 10, &DroneControl::collision_cb, this);
        ...
        TargetPosition.coordinate_frame = mavros_msgs::PositionTarget::FRAME_BODY_NED; // Use body frame
